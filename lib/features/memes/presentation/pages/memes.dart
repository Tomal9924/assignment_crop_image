import 'package:memes_life/features/meme_details/meme_details.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<ReadBloc>(context).add(const ReadMemes());
  }
...
class HomeHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Padding(
        padding: EdgeInsets.symmetric(horizontal: 20), child: SearchField());
  }
}
              ...
              return Padding(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ProductCard(
                      meme: state.memes[index],
                      onPress: () {
                        context.pushNamed(MemeDetailsPage.name,
                            extra: state.memes[index]);
                      },
                    );
                  },
                ),
